...
const registerUser = async (req, res) => {
  ...
  try {  
    ...
    const insertUserQuery =
      "INSERT INTO users (fullname, username, email, password, images) VALUES ($1, $2, $3, $4, $5) RETURNING user_id";
    ...
    const insertUserProfileQuery =
      "INSERT INTO user_profile (user_id, username, email, fullname, images) VALUES ($1, $2, $3, $4, $5)";
    await db.query(insertUserProfileQuery, [
      user_id,
      username,
      email,
      fullname,
    ...
    res
      .status(201)
      .json({ message: "User registered successfully", token, user_id });
  } catch (error) {
